...
interface ApiService {
    ...
    suspend fun tancarIncidencia(
        @Header("Authorization") token: String,
        @Part("IdIncidencia") idIncidencia: RequestBody,
        @Part("DescripcioIncidencia") descripcioIncidencia: RequestBody,
        @Part("SolucioAdaptada") solucioAdaptada: RequestBody,
    ...
    suspend fun getComptadorsPerPlanta(
        @Header("Authorization") token: String,
        @Path("plantaNom") plantaNom: String
    ...
    // ==========================================
    // REGISTRES DE CONSUM (HISTORIC) I MODIFICACIÓ DE REGISTRES
    // ==========================================
